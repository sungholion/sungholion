...
|기간|활동|주관|
|:-:|-:|:-|
|<sub>2025.07</sub> | '빅데이터 분석 산업 솔루션' 프로젝트 대상 수상 | 삼성아카데미, 삼성SDS |
|<sub>2025.06</sub> | '부스트캠프 AI Tech Camp 프리코스' 참여 | 부스트코스 |
|<sub>2025.05</sub>| 'AI Vibe Coding 해커톤' 참여 | 베이스캠퍼스 |
|<sub>2025.01 ~ 25.02</sub>| 'AI 커리어스쿨' 수료 | Google, 루트임팩트 |
|<sub>2022.10</sub>| '아이디어 해커톤' 장려상 수상 | 경북대학교 SW교육원 |
...
## 🧩 Engineering Values
### 객관적인 근거를 바탕으로, 상황에 적합한 기술을 선별하여 적용하고자 합니다.
- 기능 구현 전에 시스템 구조와 요구사항, 예외 상황을 충분히 검토한 뒤, 성능 지표와 테스트 결과 등을 비교하여 가장 합리적인 기술을 선택하려 노력합니다.
- 관습이나 유행에 따르지 않고, 각 기술의 장단점을 비교해 적재적소에 적용하려 노력합니다.
### 상상을 좋아합니다.
- 머릿속에 떠오르는 아이디어를 주변과 함께 나누고 발전시키는 과정을 즐기며, 이를 직접 구현하고 검증하는 과정에서 배우고 성장하는 데 큰 보람을 느낍니다.
...
|--------|-------------|------|------|--------|--------|--------|
| [<img src="https://github.com/user-attachments/assets/654c1574-9b8a-4cae-b954-957d90ef0559 " width="100"/>](https://github.com/sungholion/BearingGuardian) | **Bearing Guardian** | AI 기반 베어링 모니터링 시스템 | 4인 | 25.06.24&nbsp;~&nbsp;25.07.22&nbsp;(4주) | [💻 GitHub](https://github.com/sungholion/BearingGuardian) | [📽️ Video](https://www.youtube.com/watch?v=W9PzyrVhdhs&ab_channel=EOBLUE) |
